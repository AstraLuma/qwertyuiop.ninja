...
[VictoriaMetrics](https://docs.victoriametrics.com/victoriametrics/) and its friends, [VictoriaLogs](https://docs.victoriametrics.com/victorialogs/) and [VictoriaTraces (alpha)](https://docs.victoriametrics.com/victoriatraces/), are the new kids on the observability block. They promise easier operations with less resources and more features. At least, I don't need to deploy 8 daemons to get all my data stored and indexed.
...
4. Runs fpm
5. Uploads the resulting package files to artifacts and the deb repo
...
I'm starting with a vanilla Debian using [LXC](https://linuxcontainers.org/) and managed by [Proxmox](https://www.proxmox.com/). I created a data volume at `/var/lib/victoria`, since my box has tiered storage (NVMe root with spinning rust array).
