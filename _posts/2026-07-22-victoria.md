...
I'm using the Grafana container (for now), since it's a lot easier to get going than the package, and making use of [compose & my caddy ingress](/2026/07/22/docker-ingress.html):
